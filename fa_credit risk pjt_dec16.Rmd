...
plot(perf_bag_11,col='red',main="ROC curves of all 8 classification techniques",xlab="FPR",ylab="TPR",col.main='sea green',legend=TRUE,auc=TRUE,add.legend=TRUE)
...
main="Relative Importance of Explanatory variables",cex.names=0.7,las=3,col='blue')
